...
void tcp_session::write(packet const& p) {
    ...
    boost::asio::async_write(
            ...
            [self = std::static_pointer_cast<tcp_session>(shared_from_this()), payload = std::move(payload)](const boost::system::error_code &error, std::size_t bytes_transferred) {
...
void tcp_session::read_header() {
    boost::asio::async_read(
            ...
            [self = std::static_pointer_cast<tcp_session>(shared_from_this())](const boost::system::error_code &ec, std::size_t bytes_transferred) {
